       ...
       <section className="w-screen h-screen overflow-hidden">
            <div className="relative w-screen h-[100vh] bg-gradient-to-l from-[#434343] to-[#000000] text-white flex flex-col items-start justify-start overflow-hidden">
                ...
                <div className="absolute w-screen h-screen lg:flex lg:flex-col lg:items-end lg:justify-start flex-col-centered text-5xl">
                    ...
                    <div className="sm:w-auto font-lexend text-lg sm:text-xl lg:flex lg:items-end lg:justify-end flex-col-centered sm:pr-16">
                        <div className="grid grid-cols-1 lg:grid-cols-[450px_400px_450px] gap-8 text-right ml-20 mt-8">
                        ...
                        <Button
                            href="https://www.robotevents.com/robot-competitions/vex-robotics-competition/RE-V5RC-25-0091.html#agenda"
                            className="2xl:w-[27vw] 2xl:h-[10vh] lg:w-[30vw] lg:h-[8vh] bg-[#E31F2B] lg:items-end flex-col-centered hover:bg-white transition duraiton-100 ease-in-out group flex-row-centered rounded-sm mt-20"
